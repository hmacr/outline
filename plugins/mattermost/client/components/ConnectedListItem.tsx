...
const ConnectedListItem = ({ integration, collection }: Props) => {
          ...
          <Popover {...popover} aria-label={t("Settings")}>
            <Events>
              ...
              <Text as="p" type="secondary">
                {t("These events should be posted to Mattermost")}
              </Text>
              <Switch
      ...
      actions={
        <ConnectedButton
          ...
          confirmationMessage={t(
            "This will prevent any future updates from being posted to this Mattermost channel. Are you sure?"
          )}
        />
      }
    />
...
export default observer(ConnectedListItem);
